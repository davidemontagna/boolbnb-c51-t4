...
export default {
    ...
    methods: {
        founderSelect(id){
            this.img = document.querySelectorAll(".about-img");
            this.founders = document.querySelectorAll(".founder");

            this.img.forEach(imm => {
                imm.classList.remove("show")
...
.show{
    display: block;
    animation: about 1000ms forwards ease-in-out;
}
